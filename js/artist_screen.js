...
import failScreen from './fail_screen';
...
const answerButton = Array.from(artistScreen.querySelector(`.game__artist`).querySelectorAll(`.artist__picture`));
...
const answerButtonClickHandler = () => {
  showScreen(getRandomElement(winScreen, failScreen, timeFailScreen));
};
